...
public:
  ...
  void set_storage(GLsizeiptr size, const void *data,
                   GLbitfield flags = 0) const;
  ...
  void copy_sub_data(const Buffer &source, GLintptr read_offset,
                     GLintptr write_offset, GLsizeiptr size) const;

  void clear_data(GLenum internalformat, GLenum format, GLenum type,
